...
**Current boundary:** Exact attempt-3 closed asset `D0C0BE25471A92D65948132CE6154BA8AF56FF1F59FCDB8D0C4EDF64B206747A`, the later attempt-1 blink artifact at clean HEAD `612f252f7f75a301c275212f4dd4185d6b75023f`, and Task 7's first live occlusion artifact at HEAD `9ee97edc8dd71d183bcd48a23196014383d14929` remain `FAIL`. Task 8 separated both shortened lids from the surrounding hair, but the user then identified the screen-right closed eye as globally too far right. Task 9's working tree uses a whole-frame face-region replacement and measures a `2.99269px` left movement against the requested `3px`, inside a strict `0.01px` final-native bound; deterministic static inspection and automated checks pass, while a clean live blink sequence and direct user acceptance remain `UNVERIFIED`.
