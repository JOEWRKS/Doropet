...
The exact attempt-4 runtime is PID `49424`, started `2026-08-30T00:48:38.5829190+09:00` from the attempt-4 EXE SHA-256 `D7C45FC8...D37F1D`. Primary captured 360 actual-desktop frames over 14.831 seconds. Two separate ordered sequences (`119..126` and `167..173`) show `open → compact squint → wider closed ⌣ → compact squint → open`. Both lids share a visible baseline and curve language, the viewer-right lid remains separated from the foreground bang, no purple/white residue or extra eye mark appears, and reverse opening remains coherent. Primary exact-runtime visual verdict is `PASS`; direct user acceptance remains `UNVERIFIED` until the user observes the running attempt-4 app.

Task 20 source/static integration consumes only Task 19 attempt-2 pair B. Product squint `615C758D82F745F41D22547B1B42DB16AAF6ACA900229F55823DFD82A6584721` and closed `319C3E931C8D9D2D32CB172B1AB7617EB7362700FC832182F9B187B0BAB9DFBB` are byte-identical to the selected scratch inputs; canonical open remains `238AC7F0ACC765ABC40AE3E13543E088BC3F694C0D4FBC99BDFD99648D94B511`. Strict RED reproduced Task 18's unequal `53.5 / 55.5` final centers, widths `6 / 5`, and one-row depth before replacement. The exact full-region contract now requires equal final centers, width `7`, depth `2`, distinct compact squint, zero purple/eye-white, unchanged alpha/outside-region pixels, and preserved canonical hair. Focused/protected suites, Core `78 / 78`, Release build, and exact native/nearest-neighbor inspection pass at the source/static layer. That layer was independently clean before publish; the later attempt-4 runtime and primary live `PASS` are recorded above. Direct user acceptance alone remains `UNVERIFIED`.
