...
$closedEyeGeometry=@{
    ...
    Right=@{P0=@(90.75,125.90);P1=@(96.10,133.80);P2=@(101.00,126.30)}
}
$rightEyeBlankGeometry=@{P0=@(90.75,125.90);P1=@(96.10,133.80);P2=@(101.00,126.30)}
$rightHalfClosedGeometry=@{P0=@(90.75,125.90);P1=@(96.10,133.80);P2=@(101.00,126.30)}
