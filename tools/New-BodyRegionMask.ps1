...
# Frozen from the canonical source before any reconstructed candidate was viewed.
# Multiple runs on a row preserve source occlusions instead of bridging protected pixels.
$sourceContourCaptureRuns = @(
    '110:160-161'
    '111:159-162'
    '112:158-163'
    '113:157-164'
